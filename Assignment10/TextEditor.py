...
# Attach scrollbars to the Text widget
 ...
 # Format menu
    ...
    def choose_font(self):
        ...
        font_window.geometry("300x150") # set wundow size

 # Create a list of available font families
        tk.Label(font_window, text="Font Family:").pack(pady=5) # Add a label for font family
        families = list(font.families()) # returns all available font families
        font_listbox = tk.Listbox(font_window, height=5) # create a scrollable list showing 5 items at a time
...
#  Add a label and spinbox for font size
        tk.Label(font_window, text="Font Size:").pack(pady=5) # Font Size
        font_size_var = tk.IntVar(value=12) # create a variable to store the selected size, defaulting 12
        size_spinbox = tk.Spinbox(font_window, from_=8, to=72, textvariable=font_size_var) # lets the user choose a number between 8 and 72
